unit UMovimentacaoEntrada;

interface

type

  TMovimentacaoEntrada = class(TObject)
  private
...
function TMovimentacaoEntrada.alterar: Boolean;
Var
...
function TMovimentacaoEntrada.excluir: Boolean;
var
  sql : string;
begin
  Result := True;
...
function TMovimentacaoEntrada.incluir: boolean;
var
  sqlInsert,
  sqlCampos,
  sqlValues : string;
...
function TMovimentacaoEntrada.pesquisarIdEntrada: Boolean;
var
  sql : string;
