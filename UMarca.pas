  ...
  Result := True;
   ...
   try
      ...
      ' from Marca Marc ' ;
       ...
       DmMarca.qPesqMarcaObj.Parameters.ParamByName('Marc_id').Value := Self.Id;
       DmMarca.qPesqMarcaObj.Open;

       Result := not DmMarca.qPesqMarcaObj.IsEmpty;

       if Result then
       begin
         Self.Nome := DmMarca.qPesqMarcaObj.FieldByName('Marc_Nome').AsString;
